---
title: "Práctica de desarrollo 1. PD01. Hola Mundo<small><br>Biogeografía (GEO-131)<br>Universidad Autónoma de Santo Domingo (UASD)<br>Semestre 2024-02</small>"
author: "El Tali"
...
- Comprendes los tipos de objetos básicos en R y su aplicación en un análisis biogeográfico/ecológico.
...
> En el archivo `mi-primer-manuscrito.Rmd`, coloqué mayúsculas allí donde debes rellenar contenido, pero dichas partes del documento no son las únicas que deberás atender, tal como verás en el detalle a continuación.
...
- [Invitación de GitHub Classroom de esta práctica](https://classroom.github.com/a/hiEyUvci).
